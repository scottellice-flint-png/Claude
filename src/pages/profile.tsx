...
const NAV_ITEMS = [
  ...
  { id: 'social', label: 'Social & Following', icon: 'social', href: '/social' },
  { id: 'ideas', label: 'Ideas & Posts', icon: 'ideas', href: '/ideas' },
              ...
              <div className="space-y-2">
                ...
                <label className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 cursor-pointer border border-gray-200">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">Predictions are private and won't appear anywhere on the app</p>
                  </div>
                  <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
